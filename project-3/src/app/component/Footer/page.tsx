        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col gap-5">
            <div className="mb-4 flex gap-2">
              <span>
              <Image src={`/images/logo1.png`} alt="logo" width={40} height={50} />
              </span>
            ...
            <Link href={"https://www.linkedin.com/in/muhammad-kashif-ali-872a52264/"} target="_blank"><FaLinkedin /></Link>
            <Link href={"https://github.com/M-Kashif-ALI?tab=repositories"} target="_blank"> <FaGithubSquare /></Link>
            </div>
          </div>
